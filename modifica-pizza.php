...
<html lang="en">
 ...
 if(isset($_REQUEST["edit"])){
     ...
     $prezzo= $_REQUEST["prezzo"];
      ...
      $sql= " UPDATE Pizze SET nome_pizza='$nome', ingredienti='$ingredienti', prezzo=$prezzo WHERE id=$id";
  ...
  <body>
    ...
    <div class="container">
    	<div class="row">
         ...
         <form action="modifica-pizza.php?id=<?php echo $id ?>&edit=true" method="post">
