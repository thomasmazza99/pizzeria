...
<html lang="en">
  ...
  if(isset($_REQUEST["id"])){
 	 $id= $_REQUEST["id"];
           ...
           $sql= "SELECT * FROM `Insalate` WHERE id=".$id;
           $result = $conn->query($sql);
           if ($result->num_rows > 0) {
             	while($row = $result->fetch_assoc()) {
                	$nome=$row["nome_insalate"];
 ...
 if(isset($_REQUEST["edit"])){
     ...
     $prezzo= $_REQUEST["prezzo"];
      ...
      $sql= " UPDATE Insalate SET nome_insalate='$nome', ingredienti='$ingredienti', prezzo=$prezzo WHERE id=$id";
  ...
  <body>
    ...
    <div class="container">
    	<div class="row">
         ...
         <form action="modifica-insalate.php?id=<?php echo $id ?>&edit=true" method="post">
