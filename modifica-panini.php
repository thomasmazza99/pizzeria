...
<html lang="en">
 ...
 if(isset($_REQUEST["edit"])){
     ...
     $prezzo= $_REQUEST["prezzo"];
      ...
      $sql= " UPDATE Panini SET nome_panino='$nome', ingredienti='$ingredienti', prezzo=$prezzo WHERE id=$id";
           
           $result = $conn->query($sql);
  		$conn->close();
        header("location: panini.php");
 }
  ?>
  ...
  <body>
    ...
    <div class="container">
    	<div class="row">
         ...
         <form action="modifica-panini.php?id=<?php echo $id ?>&edit=true" method="post">
              ...
              <a href="panini.php" class="btn btn-default">Annulla</a>
            </form>
   		</div>
